...
namespace DS4WinWPF.UI.Control.CustomStyleEx.ButtonEx
{
    ...
    internal class cButton_converter_clickpos2xy : IMultiValueConverter
    {
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            try
            {
                var xy = double.Parse($"{values[0]}");
    ...
    internal class cButton_converter_size2brush : IMultiValueConverter
    {
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
    ...
    internal class cButton_converter_minradius : IMultiValueConverter
    {
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
    ...
    internal class cButton_converter_opacity2scale : IMultiValueConverter
    {
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
    ...
    internal class cButton_converter_cornerradius2double : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
    ...
    internal class cButton_converter_size2rect : IMultiValueConverter
    {
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            try
    ...
    internal class cButton_converter_thickness2margin : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
    ...
    internal class cButton_converter_anm2radius : IMultiValueConverter
    {
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            var w = double.Parse($"{values[0]}");
