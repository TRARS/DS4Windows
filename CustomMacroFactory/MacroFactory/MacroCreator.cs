...
namespace CustomMacroFactory.MacroFactory
{
    public partial class MacroCreator
    {
        ...
        private List<MacroBase> game_list = new();
    ...
    public partial class MacroCreator
    {
        public List<MacroBase> CurrentGameList => this.game_list;
        public MacroBase? CurrentRunnableMacro => is_busy ? null : game_list.Find(item => item.Selected);
    }
}
