...
namespace CustomMacroFactory.MVVM.Helpers
{
    ...
    {
        public static async Task OpenDialog(string msg, string token)
        {
        ...
        public static void OpenImageColorPicker()
        {
            WeakReferenceMessenger.Default.Send(new OpenChildFormMessage(new()
            {
                ...
                ViewModel = MainEntry.GetRequiredService<ImageColorPickerVM>(),
